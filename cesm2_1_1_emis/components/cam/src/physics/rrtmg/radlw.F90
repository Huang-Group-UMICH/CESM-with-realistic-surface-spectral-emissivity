...
subroutine rad_rrtmg_lw(lchnk   ,ncol      ,rrtmg_levs,r_state,       &
                        pmid    ,aer_lw_abs,cld       ,tauc_lw,  surface_emis,      & ! Xiuhong Chen added surface_emis on June 26, 2019
                        qrl     ,qrlc      ,                          &
                        flns    ,flnt      ,flnsc     ,flntc  ,flwds, &
                        flut    ,flutc     ,fnl       ,fcnl   ,fldsc, &
                        lu      ,ld       , spec_lwdn)  !Xiuhong Chen add lwdflxs on June26, 2019
...
!
   ...
   !  added by Xiuhong Chen, June26 2019
   real :: surface_emis(pcols,nbndlw)
   real(r8) :: spec_lwdn(nbndlw,pcols)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !  Xiuhong Chen changged here, June 26 2019
!    emis(:ncol,1:nbndlw) = 1._r8
     emis(:ncol,1:nbndlw) = 1._r8*surface_emis(:ncol,1:nbndlw)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   if (associated(ld)) then
      ...
      spec_lwdn(:,:) = lwdflxs(:,:ncol,1)  ! Xiuhong Chen added here on June26, 2019
