...
#include "shr_assert.h"
  ...
  use CanopyStateType      , only : canopystate_type  ! Xiuhong Chen added on June26, 2019
...
contains
  ...
  subroutine lnd2atm(bounds, &
       ...
       lnd2atm_inst, canopystate_inst, & ! Xiuhong Chen added on June26,2019
    ...
    type(lnd2atm_type)          , intent(inout) :: lnd2atm_inst 
    type(canopystate_type) , intent(in)     :: canopystate_inst ! Xiuhong Chen added on June26, 2019
    ...
    call p2g(bounds, &
     ...
     call p2g(bounds, &
          canopystate_inst%tlai_patch(bounds%begp:bounds%endp),lnd2atm_inst%tlai(bounds%begg:bounds%endg),&
          p2c_scale_type='unity', c2l_scale_type= 'unity',l2g_scale_type='unity')
