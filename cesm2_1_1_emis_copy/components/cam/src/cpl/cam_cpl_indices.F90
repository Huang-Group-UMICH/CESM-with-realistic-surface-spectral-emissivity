module cam_cpl_indices
  ...
  integer :: index_a2x_Faxa_lwdn       ! downward lw heat flux
   integer :: index_a2x_Faxa_lwdn_spec(16) = 0      ! downward lw heat spectral flux ! added on June26, 2019 by Xiuhong Chen
  integer :: index_a2x_Faxa_emis_spec(16) = 0   ! surface spectral emissiviy ! added on June26, 2019 by Xiuhong Chen
  ...
  integer :: index_x2a_Sl_tlai         ! leaf area index   ! added by Xiuhong Chen on June26, 2019
  integer :: index_x2a_Sl_ts_atm         ! ts_atm   ! added by Xiuhong Chen on June26, 2019
  integer :: index_x2a_Sl_srf_emis_spec(16)  ! surface spectral emissivity !added by Xiuhong Chen on June26, 2019
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    character(len= 2) :: cnum   ! Xiuhong Chen added on June26, 2019
    integer :: j ! Xiuhong Chen added on June26, 2019
    ...
    index_x2a_Faoo_fdms_ocn = mct_avect_indexra(x2a,'Faoo_fdms_ocn',perrWith='quiet')
        ...
        !!!!!!!!!!!!!1 Xiuhong Chen added on June26, 2019
